    ...
    <div className="relative bg-transparent">
      <div className="relative px-4 lg:px-24 py-8 text-slate-100 max-w-5xl mx-auto">
        <div className="fixed top-0 left-0 w-full h-1 bg-gray-800 z-50">
          <div
            className="h-full bg-gradient-to-r from-green-500 to-green-600 w-0 reading-progress 
        ...
        <div className="relative ">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold pb-10 text-white">
            {post.title}
          </h1>
        </div>
        ...
        <div
          ...
          className="flex items-center sm:my-8 group cursor-pointer  relative overflow-hidden rounded-xl"
        >
          {/* Desktop-only effects */}
          <div
            className="hidden md:block absolute inset-0 bg-gradient-to-r from-gray-800/50 to-transparent opacity-0 
             group-hover:opacity-100 transition-all duration-300"
          ></div>
          <div
            className="hidden md:block absolute -inset-1 bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 
               group-hover:opacity-20 blur-xl transition-all duration-500"
          ></div>

          <div className="flex select-none items-center  md:p-6 relative z-10 w-full">
            <div className="relative">
              <Avatar
                name={post.author.firstName.charAt(0).toUpperCase()}
                big={true}
              />
              <div
                className="hidden md:block absolute inset-0 bg-green-500/20 rounded-full blur-xl 
            ...
            <div className="flex-col justify-start px-4 md:px-6">
              <div
                className="text-lg md:text-xl font-semibold text-white md:group-hover:text-green-300 
            ...
            <div className="hidden md:flex ml-auto items-center gap-2">
              <span
                className="text-sm text-gray-400 opacity-0 group-hover:opacity-100 
        ...
        <div className="relative">
          <div
            className="prose prose-lg prose-invert max-w-none mt-8 leading-relaxed text-gray-100
